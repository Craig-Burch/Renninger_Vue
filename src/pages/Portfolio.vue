  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <a href ="/img/PortfolioPages.jpg" target="blank">
       <div class="workcontainer">
         <img src="/img/PortfolioPages.jpg">
         <div class="overlay">
           <div class="text">
            <hr>
             net
    ...
    <div class="col-md-4">
      <card>
        ...
        <div class="workcontainer"> 
          <img src="/img/PortfolioPages4.jpg">
          <div class="overlay">
            <div class="text">
              <hr>
               porsche
    ...
    <div class="col-md-4">
      ...
      <a href ="/img/PortfolioPages8.jpg" target="blank">
       <div class="workcontainer">
         <img src="/img/PortfolioPages8.jpg">
         <div class="overlay">
           <div class="text">
            <hr>
             the clef club
    ...
    <div class="col-md-4">
      <card>
        ...
        <div class="workcontainer"> 
          <img src="/img/PortfolioPages11.jpg">
          <div class="overlay">
            <div class="text">
              <hr>
               mho
    ...
    <div class="col-md-4">
      ...
      <a href ="/img/PortfolioPages16.jpg" target="blank">
       <div class="workcontainer">
         <img src="/img/PortfolioPages16.jpg">
         <div class="overlay">
           <div class="text">
            <hr>
             wasteland
